...
`!name` -`НЕ РАБОТАЕТ` воспроизводит звуковую команду за души. Название, стоимость и кулдауны звуковых команд смотрите в файле [sounds.csv](sounds.csv)

**Кулдаун самой команды 3 минуты**
