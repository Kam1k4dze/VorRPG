...
2. Переводим баллы в души с помощью наград 1к1(Вероятность успеха 100%) или 1к2(Вероятность успеха зависит от удачи) (внутренняя валюта бота) **В БЕТЕ ОТКЛЮЧЕНО**.
3. С помощью душ качаем характеристики персонажа.
4. Дуэлимся, чтобы получить ещё больше душ.
5. Способы получить випку:
   * С помощью `!steal` воруем випку у случайного випа, в случае проигрыша бан на 24 часа и +50000 душ випу.
