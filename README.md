...
### В Бете время бана установлено на 30 минут

## Суть

1. Копим баллы канала.
2. Переводим баллы в души(внутренняя валюта бота) с помощью наград 1к1(Вероятность успеха 100%) или 1к2(Вероятность успеха зависит от удачи) 
   * **В БЕТЕ ОТКЛЮЧЕНО ВАМ УЖЕ ВЫДАНЫ ДУШИ**.
